...
class homepage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      return Scaffold(
        backgroundColor: Color.fromARGB(255, 141, 63, 141),
        appBar: AppBar(
          title: const Center(
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(0, 10, 0, 0),
                child: Row(children: [
                  Icon(Icons.email, color: Color.fromARGB(255, 208, 244, 3)),
                  Text(
                ...
                children:[
                  IconButton(
                    ...
                    icon:const Icon(
                      ...
                      color: Color.fromARGB(255, 188, 244, 3),
                    ),
                    onPressed: () {
                      Navigator.push(
                        context,
                ...
                children:[
                  IconButton(
                    ...
                    icon: const Icon(
                      ...
                      color: Color.fromARGB(255, 176, 244, 3),
                    ),
                    onPressed: () {
                      Navigator.push(
                        context,
                ...
                children:[
                  IconButton(
                    ...
                    icon: const Icon(
                      ...
                      color: Color.fromARGB(255, 216, 244, 3),
                    ),
                    onPressed: () {
                      Navigator.push(
                        context,
